...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements ISysDeptService
{
    ...
    public List<Long> queryChildId(Long deptId) {
        return deptMapper.queryChildId(deptId);
    }
    ...
    public boolean insertDept(SysDept dept)
    {
        if (dept.getParentId() != 0L){
            SysDept info = super.getById(dept.getParentId());
    ...
    {
        SysDept newParentDept = super.getById(dept.getParentId());
        SysDept oldDept = super.getById(dept.getDeptId());
